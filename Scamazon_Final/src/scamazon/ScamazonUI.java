...
import static scamazon.Globals.ItemArray;
import static scamazon.Globals.Search;
import static scamazon.Globals.VariableCategoryArray;
import static scamazon.Globals.cart;
import static scamazon.Globals.searchedItems;
...
//        item1.setStock(9);
        ...
        jTextArea1.setText(ItemArray.get(0).displayItem());
        //System.out.println(ItemArray.get(0).displayItem());
        jTextArea2.setText(VariableCategoryArray.get(1).displayItem());
        jTextArea3.setText(VariableCategoryArray.get(2).displayItem());
        jTextArea4.setText(VariableCategoryArray.get(3).displayItem());
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addGap(29, 29, 29)
                        .addComponent(ImageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 407, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(335, 335, 335))
        );
...
//        System.out.println(item1.getItemName());
        ...
        Items = Globals.Search(sb,ItemArray,VariableCategoryArray);
        ...
        for (int i = 0; i < Items.size(); ++i){
            if(i == 0){
                jTextArea1.setText(Items.get(i).displayItem());
            }
            else if(i == 1){
                jTextArea2.setText(Items.get(i).displayItem());
            }
            else if(i == 2){
                jTextArea3.setText(Items.get(i).displayItem());
            }
            else if(i == 3){
                jTextArea3.setText(Items.get(i).displayItem());
            }
        ...
        //int i = Search(sb,ItemArray,VariableCategoryArray);
        //VariableCategoryArray.get(i).displayItem();
//        System.out.println(ItemArray.get(i).getItemName());
//        jTextArea1.setText(ItemArray.get(i).getItemName());
...
// TODO add your handling code here
        ...
        for(int i = 0; i < Globals.MAX; i++){
            String category = ItemArray.get(i).getCategory();
            System.out.println(category);
            if(new String("Electronics").equalsIgnoreCase(category) ) {
                jTextArea1.setText(ItemArray.get(i).displayItem());
            }
        }
        jTextArea1.setText(ItemArray.get(1).displayItem());
        jTextArea2.setText(ItemArray.get(0).displayItem());
        jTextArea3.setText("");
        jTextArea4.setText("");
...
// TODO add your handling code here:
    ...
    private void homeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_homeButtonActionPerformed
      SearchDisplay.setText("");
        ...
        jTextArea1.setText(ItemArray.get(0).displayItem());
        System.out.println(ItemArray.get(0).displayItem());
        jTextArea2.setText(ItemArray.get(1).displayItem());
        jTextArea3.setText(ItemArray.get(2).displayItem());
        jTextArea4.setText(ItemArray.get(3).displayItem());
...
// TODO add your handling code here:
    ...
    private void jTextArea1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextArea1KeyPressed
        // TODO add your handling code here:
       // ItemArray.get(0).displayItem();
    }//GEN-LAST:event_jTextArea1KeyPressed

    private void Add1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add1MouseClicked
        // TODO add your handling code here:
        cart.addItem(searchedItems.get(0));
        System.out.println(cart.shoppingList.get(0).displayItem());
    }//GEN-LAST:event_Add1MouseClicked

    private void Add3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add3MouseClicked
        // TODO add your handling code here:
        cart.addItem(searchedItems.get(2));
        System.out.println(cart.shoppingList.get(2).displayItem());
    ...
    private void Add2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add2MouseClicked
        // TODO add your handling code here:
        cart.addItem(searchedItems.get(1));
        System.out.println(cart.shoppingList.get(1).displayItem());
    ...
    private void Add4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Add4MouseClicked
        // TODO add your handling code here:
        cart.addItem(searchedItems.get(3));
        System.out.println(cart.shoppingList.get(3).displayItem());
    }//GEN-LAST:event_Add4MouseClicked
    int i = 1;
    private void PreviousButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PreviousButtonActionPerformed
        String str = "/Users/Kyle/desktop/image"+ --i + ".png";     
        //String str = "/Users/alexbuhler/Desktop/image2.png"; 
        ImageIcon image = new ImageIcon(str);
        ImageLabel.setIcon(image);// TODO add your handling code here:
